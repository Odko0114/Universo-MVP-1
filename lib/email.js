...
const sendEmailChangedNotice = (name, oldEmail, newEmail) => sendMail({ to: oldEmail, ...emailChangedTemplate({ name, oldEmail, newEmail }) });
...
module.exports = {
  ...
  verifyEmailTemplate, emailVerifiedTemplate, passwordResetTemplate, welcomeTemplate, emailChangedTemplate,
};

...
const NAME_HINTS = [
  [
    /\b(polytech|polit+ecnico|institute of technology|technical|technolog|technische|technique)\b/i,
  ...
  [
    /\b(art|music|design|conservatoire|conservatory|fine arts|academy of)\b/i,
    ["Arts & Design"],
  ],

...
const TIMELINE = [
  ...
  },
  {
    ...
    kind: "self",
    hint: "Submit at least one application.",
  },
  {
    key: "offer_received",
    label: "Received an offer",
    kind: "self",
    hint: "Mark this when an offer arrives — a real milestone.",
  },
  {
    key: "visa_started",
...
const DOCUMENTS = [
  ...
  },
  {
    ...
    hint: "Your motivation letter / statement of purpose.",
  },
  {
    key: "cv",
    label: "CV / résumé",
...
function readiness(inputs) {
  ...
  if (inputs.savedCount > 0) {
    if (has("offer")) {
      appScore = 100;
      appDetail = "Offer received — a real milestone. 🎉";
    } else if (has("applied")) {
      appScore = 75;
      appDetail =
        "Application submitted. Track the rest of your shortlist as you go.";
    } else if (has("researching")) {
      appScore = 45;
      appDetail =
        "Researching your targets — move one to “Applied” when you submit.";
    } else {
      appScore = 25;
      appDetail =
        "You have a shortlist — start researching and applying to your top choices.";
    }
  }
  dims.push({
    key: "application",

...
const validate = {
  ...
  // Exposed so the anonymous "What fits you?" quick-match can be sanitized with
  // the exact same rules as a registered profile — one source of truth for what
  // counts as a valid field/degree/budget/country.
  matchProfileFields,

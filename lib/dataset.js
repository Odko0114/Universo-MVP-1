...
const { canonicalCountry, isEU } = require('./countries');
...
module.exports = { buildDataset, mergeSources, hostKey, applyRankings, cleanName, describeEter, assignVerifiedTier, VERIFIED_CAP };

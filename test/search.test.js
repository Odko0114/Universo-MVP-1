...
const sample = [
  { id: 'a', name: 'São Paulo State University', country: 'Brazil', fields_of_study: [], degree_levels: [], language_of_instruction: [] },
  { id: 'b', name: 'University of Tokyo', country: 'Japan', student_count: 28000, fields_of_study: [], degree_levels: [], language_of_instruction: [] },
  { id: 'c', name: 'Tokyo Institute of Technology', country: 'Japan', student_count: 10000, fields_of_study: [], degree_levels: [], language_of_instruction: [] },
  { id: 'd', name: 'Curated Uni', country: 'Germany', source: 'curated', tuition_range: { min: 0, max: 0, period: 'year' }, fields_of_study: ['Engineering'], degree_levels: ['Master'], language_of_instruction: ['English'] },
];
